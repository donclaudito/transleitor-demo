      ...
      <div className="max-w-4xl mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            Gere evoluções SOAP, Livres e Simples em segundos. IA que entende o setor, analisa evoluções
            anteriores cronologicamente, integra exames, prescrição e comorbidades — e ainda{' '}
            <strong className="text-foreground">relê a evolução</strong> apontando o que falta documentar
            antes de você assinar.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/demo" className="group inline-flex items-center gap-2 px-8 py-4 bg-primary text-primary-foreground rounded-2xl text-sm font-bold hover:opacity-90 transition-all shadow-lg btn-press">
