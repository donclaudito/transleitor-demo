...
// NÚMEROS REAIS, conferidos por teste (`testes/testar-front-page.mjs`): as especialidades vêm de
// `PANELS_ESPECIALIDADE` e as opções clínicas de `contarItens(montarSecoesDeSinais(...))`. Se alguém
// acrescentar uma área ou um item e esquecer de atualizar aqui, o teste REPROVA — número inventado
// numa página de app médico é o mesmo problema que dado inventado numa evolução.
const stats = [
